...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen bg-black overflow-hidden">
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              />
              <feGaussianBlur
                stdDeviation="249.401"
                result="effect1_foregroundBlur_1_594"
              />
            </filter>
          </defs>
        </svg>
      ...
      <div className="absolute inset-0 md:hidden" style={{}}>
        ...
        >
          <g filter="url(#filter0_f_1_1013)">
            <path
              d="M403.5 424.437C356.815 467.496 38.461 474.374 15 448.937C9.18113 402.487 213.637 423.937 347.637 381.937C384.233 315.202 427.946 135.048 380 -80.0631C403.461 -54.6261 450.185 381.378 403.5 424.437Z"
              fill="#8A1DFF"
            />
          </g>
          <defs>
            ...
            >
              ...
              />
              <feGaussianBlur
                stdDeviation="62.3503"
                result="effect1_foregroundBlur_1_1013"
              />
            </filter>
          </defs>
        </svg>
      ...
      <div className="relative z-10 pb-2 md:pb-8 mt-6 sm:mt-8 w-full px-4 md:px-0">
        <FeatureBadges />
      </div>
